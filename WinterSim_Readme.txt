...
python wintersim_muonio_control.py --a --fr 1.25
python wintersim_muonio_control.py --a --fr 1.5
python wintersim_muonio_control.py --a --fr 1.75
python wintersim_muonio_control.py --a --fr 2.0
...
If you want to take control of the vehicle, press P or start control script without --a argument.
